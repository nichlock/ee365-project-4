...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS18 } [get_ports { led0_r }]; #IO_L21P_T3_DQS_AD14P_35 Sch=led0_r
...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS18 } [get_ports { ja[0] }]; #IO_L17P_T2_34 Sch=ja_p[1]
...
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS18 } [get_ports { jb[1] }]; #IO_L8N_T1_34 Sch=jb_n[1]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS18 } [get_ports { jb[2] }]; #IO_L1P_T0_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS18 } [get_ports { jb[3] }]; #IO_L1N_T0_34 Sch=jb_n[2]
